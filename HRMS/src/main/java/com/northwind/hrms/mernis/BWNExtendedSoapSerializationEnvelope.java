...
public class BWNExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BWNDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BWNStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BWNDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BWNDateTimeConverter dateTimeConverter = new BWNStandardDateTimeConverter();

    public BWNExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BWNExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BWNMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName= BWNHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BWNExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BWNHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
