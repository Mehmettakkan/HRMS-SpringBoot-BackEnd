...
public class BWNKPSPublicSoap
{
    ...
    public BWNKPSPublicSoap(){}

    public BWNKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BWNKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BWNExtendedSoapSerializationEnvelope envelope= new BWNExtendedSoapSerializationEnvelope(BWNExtendedSoapSerializationEnvelope.VER11);
