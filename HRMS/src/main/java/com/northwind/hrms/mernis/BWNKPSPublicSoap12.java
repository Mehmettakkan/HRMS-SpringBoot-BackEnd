package com.northwind.hrms.mernis;
...
import com.northwind.hrms.mernis.BWNExtendedSoapSerializationEnvelope;
...
public class BWNKPSPublicSoap12
{
    interface BWNIWcfMethod
    {
        BWNExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(BWNExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public BWNKPSPublicSoap12(){}

    public BWNKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public BWNKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected BWNExtendedSoapSerializationEnvelope createEnvelope()
    {
        BWNExtendedSoapSerializationEnvelope envelope= new BWNExtendedSoapSerializationEnvelope(BWNExtendedSoapSerializationEnvelope.VER12);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,BWNExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,BWNExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new BWNIWcfMethod()
        {
            @Override
            public BWNExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                BWNExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(BWNExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(BWNIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        BWNExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,BWNExtendedSoapSerializationEnvelope envelope)
    {
